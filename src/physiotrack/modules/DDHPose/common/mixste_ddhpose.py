...
class  MixSTE2(nn.Module):
    def __init__(self, boneindex_h36m='0,1,1,2,2,3,0,4,4,5,5,6,0,7,7,8,8,9,9,10,8,11,11,12,12,13,8,14,14,15,15,16',
                 num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
        ...
        boneindex = []
        boneindextemp = boneindex_h36m.split(',')
        boneindex = []
